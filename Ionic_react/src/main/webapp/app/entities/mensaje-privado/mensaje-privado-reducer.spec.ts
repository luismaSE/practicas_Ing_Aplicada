...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENSAJEPRIVADO_LIST actions', async () => {
    ...
    it('dispatches FETCH_MENSAJEPRIVADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MENSAJEPRIVADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MENSAJEPRIVADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MENSAJEPRIVADO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MENSAJEPRIVADO actions', async () => {
      const expectedActions = [
        {
