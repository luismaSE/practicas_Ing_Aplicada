...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mensaje.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENSAJE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MENSAJE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MENSAJE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MENSAJE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MENSAJE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MENSAJE actions', async () => {
      const expectedActions = [
        {
