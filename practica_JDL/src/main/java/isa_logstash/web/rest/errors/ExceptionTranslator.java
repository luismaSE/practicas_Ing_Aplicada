package isa_logstash.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof isa_logstash.service.EmailAlreadyUsedException || ex instanceof isa_logstash.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof isa_logstash.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "isa_logstash");
    }
}
